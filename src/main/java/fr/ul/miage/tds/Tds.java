...
public class Tds {
    ...
    public Tds(String nom, Type type, Categorie cat, Integer val) {
        this.nom = nom;
        this.type = type;
        this.cat = cat;
        this.val = val;
    ...
    public Tds(String nom, Type type, Categorie cat) {
        this(nom, type, cat, 0);
    }

    public Tds(String nom, Type type, Categorie cat, Integer rang, String scope) {
        this.nom = nom;
        this.type = type;
    ...
    public Tds(String nom, Type type, Categorie cat, Integer val, Integer nbParam, Integer nbvar) {
        this.nom = nom;
        this.type = type;
        this.cat = cat;
        this.val = val;
